...
themselves:
$p(\lambda_{1,i})=\frac{C_i}{\lambda_{1,i}^{\alpha_1}}$
and
$p(\lambda_{2,i})=\frac{C_i}{\lambda_{2,i}^{\alpha_2}}$.
Consider de product distribution of the
$\lambda_{3,i}^2=\lambda_{1,i}.\lambda_{2,i}$
variable:
$p(\lambda_{3,i})=C_1.C_2.\lambda_3^{-2\alpha_2}\frac{(R_{1,R}-R_{1,L})^{\alpha_2-\alpha_1}}{\alpha_2-\alpha_1}

...
to the cases where $\alpha>3$ and $\alpha>4$.
...
tends to present power laws,
which includes distribution of human wealth, interactions, friendships;
airport connections, neuronal synaptic count.
Some advocate 
about a better fit and theoretical backbone for the superimposition of a

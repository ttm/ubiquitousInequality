...
\subsection{Inequality avising from equanimous distributions}
...
suggests a pertinence, and is regarded as such by the literature.
...
there are so many mechanisms into play that ignorance is assured and
...
One might glimpse diverse hypothesis,
...
through power laws which follow from simple propositions.
These propositions can also be observed in any power-law incidence.
...
Immediate consequences were scrutinized case-by-case.
We hypothesize that
inequality may be minimizable by the expenditure of energy
and that the characteristic $\alpha \in [2,3]$ is a consequence of
the existence of two or three types of independent resources.

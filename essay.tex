...
\vspace{25pt} % Some vertical space between the author block and abstract
\end{flushright}
}
...
and knowledge in nearly all fields.
...
regardless of the presence of it.
...
respect to the resources already allocated 
to each component.
The reminder of this introduction is dedicated
to a concise depiction of power-laws and related work.
Section~\ref{sec:form} present both and axiomatic and phenomenological
